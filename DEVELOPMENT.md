...
```bash
git remote add encore encore://auth-system-bn9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/auth-system-bn9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/auth-system-bn9i/settings/integrations/github)
